({
    processTermChanged : function(component , event){
        //when the term changes the whole product is removed from the cart.
    ...
    processQuantityChanged : function(component , event) {
        ...
        if(cart && termId && termType && termId.length > 0 && termType.length > 0){
            this.payloadAction(component , cart , product , termId , termType, event);
    ...
    payloadAction : function(component , cart , product , termId , termType , event){
        ...
        if(product.isBundledProduct){
            ...
            callAction = this.buildBundle(component , product , payload.bundleComponent , event);
    	}
    ...
    buildBundle : function(component , product , bundles , event){
        var callAction = false;
