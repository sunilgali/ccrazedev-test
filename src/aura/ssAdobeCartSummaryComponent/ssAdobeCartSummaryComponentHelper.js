({
    ...
    onNewPaymentInfoUpdated : function(component, event ){
        ...
        var newPayment = {}
        paymentInfo.city = "Bridgewater"; 
        paymentInfo.streetAddress = "New street"; 
        paymentInfo.state = "New Jersey";
        paymentInfo.country = "United States"; 
        paymentInfo.postalCode = "08807";
	...
	startSubscription : function(component , event){
        ...
        /*var newPayment = {};
        newPayment.paymentType = "Credit Card";
        newPayment.street = "Crest view";
        newPayment.city = "Bridgewater";
        newPayment.state = "New Jersey";
        newPayment.country = "United States";
        newPayment.postalCode = "08807";
        newPayment.cardType = "Visa";
        newPayment.cardNumber = "41111111111111111111";
        newPayment.expirationMonth = 9;
        newPayment.expirationYear = 2020;
        newPayment.securityCode = "121";
        newPayment.cardHolderName = "Test User";
        newPayment.email = "vdatla@docmation.com";
         */
         var payment = {"email": "test@test.com", "paymentType": "Credit Card", "street": "crest view", "city": "Bridgewater", "country": "United States", "postalCode": "08807", "cardType": "Visa", "cardNumber": "41111111111111111111", "expirationMonth": "09", "expirationYear": "2020", "securityCode": "123", "cardHolderName": "Test"};
        ...
        if(subscriptionItemId){
            ...
            action.setParams({"cartId" : cartId, "paymentModel" : ""});
        }
